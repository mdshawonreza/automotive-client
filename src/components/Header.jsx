...
const Header = () => {
    return (
        <div className="hero  w-full h-[30vh] md:h-[90vh]" style={{ backgroundImage: 'url(https://i.ibb.co/CJkkLtB/banner1.jpg)' }} >
            <div className="hero-overlay bg-opacity-60"></div>
            <div className="hero-content text-center text-neutral-content">
                <div className="max-w-md">
                    <h1 className="mb-5 text-3xl md:text-5xl font-bold text-slate-50">Get quality leads you can trust</h1>
